Durante todo o processo de criação de conta na azure e vincular com MySQL e power BI é estremamente cansativo devido a varios erros que podem ocorrer, desde de versão de aplicativo até erro de script do curso, se tornando assim um projeto muito demorado e o intuito de tranformar dados ficou em segundo plano, no caso de um banco de dados maior seria mais facil estar desenvolvendo as habilidaes de transformação e limpeza de dados.

O script correto utilizado foi este:
